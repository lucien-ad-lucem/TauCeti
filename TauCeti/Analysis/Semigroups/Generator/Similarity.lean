...
@[simp]
theorem similar_apply (S : StronglyContinuousSemigroup X) (e : X ≃L[ℝ] Y) (t : ℝ≥0) (y : Y) :
    S.similar e t y = e (S t (e.symm y)) := by
  rw [similar]
  rfl
...
theorem similar_realOperator_apply (S : StronglyContinuousSemigroup X) (e : X ≃L[ℝ] Y) (t : ℝ)
  ...
  rw [realOperator_def, realOperator_def, similar_apply]
